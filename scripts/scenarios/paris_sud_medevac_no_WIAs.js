...
const entities = [
  ...
  { nombre: 'Tactical MEDEVAC Helicopter', descripcion: 'French MEDEVAC helicopter Role 2', categoria: 'medevac_unit', country: 'France', alliance: 'friendly', elemento_identificado: 'FRA-MEDEVAC-HEL-2', activo: true, tipo_elemento: 'medevac_role_2', mobility: 'air', capacity: 1, observaciones: 'CH-47 Chinook', altitud: null, lng: 2.2503, lat: 48.5947 },

  // ---------------------------------------------------------------
  // Transport assets
  // ---------------------------------------------------------------
  { nombre: 'ITA Transport 1', descripcion: 'Italian transport vehicle', categoria: 'transportation', country: 'Italy', alliance: 'friendly', elemento_identificado: 'ITA-TRNSP-1', activo: true, tipo_elemento: null, mobility: 'ground', casevac_eligible: true, capacity: 1, observaciones: 'Toyota pickup civil', altitud: null, lng: 2.336691, lat: 48.597926 },
  { nombre: 'ITA Transport Supply 2', descripcion: 'Italian supply transport', categoria: 'transportation', country: 'Italy', alliance: 'friendly', elemento_identificado: 'ITA-TRNSP-2', activo: true, tipo_elemento: 'supply', mobility: 'ground', casevac_eligible: true, capacity: 1, observaciones: 'M-Gator', altitud: null, lng: 2.351239, lat: 48.609221 },
  ...
  { nombre: 'ESP Transport 1', descripcion: 'Spanish transport vehicle', categoria: 'transportation', country: 'Spain', alliance: 'friendly', elemento_identificado: 'ESP-TRNSP-1', activo: true, tipo_elemento: null, mobility: 'ground', casevac_eligible: true, capacity: 1, observaciones: 'VBMR Griffon', altitud: null, lng: 2.310899, lat: 48.593726 },

  // ---------------------------------------------------------------
  // UGV assets
  // ---------------------------------------------------------------
  { nombre: 'UGV Alano 1', descripcion: 'Spanish UGV Alano', categoria: 'ugv', country: 'Spain', alliance: 'friendly', elemento_identificado: 'ESP-UGV-1', activo: true, casevac_eligible: true, capacity: 1, observaciones: 'Alano model. Autonomous operation capable. Payload 700 kg. 20 km/h', altitud: null, lng: 2.325228, lat: 48.597472 },
  { nombre: 'UGV Alano 2', descripcion: 'Spanish UGV Alano', categoria: 'ugv', country: 'Spain', alliance: 'friendly', elemento_identificado: 'ESP-UGV-2', activo: true, casevac_eligible: true, capacity: 1, observaciones: 'Alano model. Autonomous operation capable. Payload 700 kg. 20 km/h', altitud: null, lng: 2.338209, lat: 48.587545 },
  { nombre: 'UGV THeMIS', descripcion: 'German UGV THeMIS', categoria: 'ugv', country: 'Germany', alliance: 'friendly', elemento_identificado: 'GER-UGV-1', activo: true, casevac_eligible: true, capacity: 1, observaciones: 'THeMIS model. Autonomous operation capable. Payload 800 kg. 25 km/h', altitud: null, lng: 2.372252, lat: 48.608309 },
];
