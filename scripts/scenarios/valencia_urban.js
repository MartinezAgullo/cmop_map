...
const entities = [
  ...
  { nombre: 'FRA INF-2',  descripcion: 'Infantry squad (urban)',  categoria: 'infantry',  country: 'France',  alliance: 'friendly', elemento_identificado: 'FRA-INF-2',    activo: true, tipo_elemento: 'Infantry',  prioridad: 5, observaciones: 'Roadblock',              altitud: null, lng: -0.3405, lat: 39.4598 },
  ...
  { nombre: 'PRT INF-1',  descripcion: 'Infantry squad (urban)',  categoria: 'infantry',  country: 'Portugal',alliance: 'friendly', elemento_identificado: 'PRT-INF-1',    activo: true, tipo_elemento: 'Infantry',  prioridad: 5, observaciones: 'Rear security',          altitud: null, lng: -0.3925, lat: 39.4682 },
  ...
  { nombre: 'H-INF-2',    descripcion: 'Hostile infantry',        categoria: 'infantry',  country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-INF-2',      activo: true, tipo_elemento: 'Infantry',  prioridad: 6, observaciones: 'Advancing',              altitud: null, lng: -0.3452, lat: 39.4769 },
  { nombre: 'H-INF-3',    descripcion: 'Hostile infantry',        categoria: 'infantry',  country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-INF-3',      activo: true, tipo_elemento: 'Infantry',  prioridad: 6, observaciones: 'Occupying block',        altitud: null, lng: -0.3513, lat: 39.4881 },
  ...
  { nombre: 'H-INF-5',    descripcion: 'Hostile infantry',        categoria: 'infantry',  country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-INF-5',      activo: true, tipo_elemento: 'Infantry',  prioridad: 6, observaciones: 'Sniper activity',        altitud: null, lng: -0.3811, lat: 39.4552 },
  { nombre: 'H-INF-6',    descripcion: 'Hostile infantry',        categoria: 'infantry',  country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-INF-6',      activo: true, tipo_elemento: 'Infantry',  prioridad: 6, observaciones: 'Harassing fire',        altitud: null, lng: -0.3440, lat: 39.4479 },
  { nombre: 'H-INF-7',    descripcion: 'Hostile infantry',        categoria: 'infantry',  country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-INF-7',      activo: true, tipo_elemento: 'Infantry',  prioridad: 6, observaciones: 'Fragmented contact',    altitud: null, lng: -0.3895, lat: 39.4786 },
  ...
  { nombre: 'H-TANK-2',   descripcion: 'Hostile MBT',            categoria: 'tank',      country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-TNK-2',      activo: true, tipo_elemento: 'MBT',       prioridad: 9, observaciones: 'Hull-down',              altitud: null, lng: -0.4040, lat: 39.4665 },
  { nombre: 'H-TANK-3',   descripcion: 'Hostile MBT',            categoria: 'tank',      country: 'Unknown', alliance: 'hostile',  elemento_identificado: 'H-TNK-3',      activo: true, tipo_elemento: 'MBT',       prioridad: 9, observaciones: 'Overwatch',             altitud: null, lng: -0.3960, lat: 39.4505 },
