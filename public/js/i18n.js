...
const I18N = {
  en: {
    ...
    'random.centre':     'Centre',
    'random.casualties': 'Casualties',
    'random.evacuators': 'Evacuators',
    'random.facilities': 'Facilities',
    'random.radius':     'Radius km',
    'random.seed':       'Seed',
    'random.generate':   'Generate & load',
    ...
    'cat.ground_vehicle':   'Ground vehicle',
    'cat.person':           'Person',
    'cat.base':             'Base',
    'cat.building':         'Building',
    'cat.infrastructure':   'Infrastructure',
    'cat.uav':              'UAV / Drone',
    'cat.ugv':              'Unmanned ground vehicle',
    'cat.default':          'Default',
    ...
    'routes.min':             'min',
    'popup.increaseAltitude': 'INCREASE ALTITUDE',
    'popup.crossesThreat':    'Crosses the threat zone of {threats} ({legs}).',
    'popup.diverted':         'DIVERTED ROUTE',
    'popup.divertedAround':   'Flies around the threat zone of {threats}.',
    'popup.leg.pickup':       'pickup',
    'popup.leg.delivery':     'delivery',
    ...
    'msg.randomLoaded':   'Random MASCAL "{name}" loaded',
    ...
    'msg.confirmDamaged': 'Mark this vehicle as damaged? Its casualties will be reassigned to other vehicles.',
    ...
    'form.capacity':        'Evacuation capacity',
    'form.capacityHint':    'Casualties per planning cycle',
    'popup.capacity':       'Capacity',
    'popup.damaged':        'Damaged',
  ...
  es: {
    ...
    'random.toggle':     'Aleatorio',
    'random.centre':     'Centro',
    'random.casualties': 'Bajas',
    'random.evacuators': 'Evacuadores',
    'random.facilities': 'Instalaciones',
    'random.radius':     'Radio km',
    'random.seed':       'Semilla',
    'random.generate':   'Generar y cargar',
    ...
    'action.markDamaged':     'Marcar averiado',
    'action.markOperational': 'De nuevo operativo',

    'cat.casualty':         'Baja',
    'cat.medical_facility': 'Instalación sanitaria',
    'cat.medevac_unit':     'MEDEVAC',
    ...
    'cat.ground_vehicle':   'Vehículo terrestre',
    'cat.person':           'Persona',
    'cat.base':             'Base',
    'cat.building':         'Edificio',
    'cat.infrastructure':   'Infraestructura',
    'cat.uav':              'UAV / Dron',
    'cat.ugv':              'Vehículo terrestre no tripulado',
    'cat.default':          'Por defecto',
    ...
    'routes.error':           'Error: {detail}',
    'routes.min':             'min',
    'popup.increaseAltitude': 'AUMENTAR ALTITUD',
    'popup.crossesThreat':    'Cruza la zona de amenaza de {threats} ({legs}).',
    'popup.diverted':         'RUTA DESVIADA',
    'popup.divertedAround':   'Rodea la zona de amenaza de {threats}.',
    'popup.leg.pickup':       'recogida',
    'popup.leg.delivery':     'entrega',
    ...
    'msg.randomLoaded':   'MASCAL aleatorio "{name}" cargado',
    ...
    'msg.confirmDamaged': '¿Marcar este vehículo como averiado? Sus bajas se reasignarán a otros vehículos.',
    ...
    'form.capacity':        'Capacidad de evacuación',
    'form.capacityHint':    'Bajas por ciclo de planificación',
    'popup.capacity':       'Capacidad',
    'popup.damaged':        'Averiado',
